...
async function f(d, profileId, today, i) {
    ...
    if (d < today)
        ...
        document.getElementById("days").innerHTML += '<li id="li'+i+'"><a href="" title="No data"><i class="	fa fa-remove"></i></a></li>';
            ...
            document.getElementById("days").innerHTML += '<li id="li'+i+'"><a href="./SetMenu.html?userId=' + profileId + '" title="Set the menu">' + i + '</a></li>';
        }else {console.log("azi "+today);
            document.getElementById("days").innerHTML += '<li id="li'+i+'"><a href="./SetMenu.html?userId=' + profileId + '" title="Set the menu"><span class="active">' + i + '</span></a></li>';
    }
